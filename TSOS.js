/**
 * @name The Sons Of Silence
 * @version 1
 * @description The Sons Of Silence Theme
 * @author Rens & Luchi
 *
...
:root {
	--app-bg: url(https://cdn.discordapp.com/attachments/875583489179783268/979157434281099314/bNaamloos-1.png);
	--app-blur: 6px;
	--app-margin: 24px;
	--app-radius: 8px; /*	-	*/
